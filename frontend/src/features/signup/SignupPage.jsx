...
const SignupPage = () => {
  const { signupInit, signupVerify, resendOtp } = useAuth();
  ...
  const handleInitSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await signupInit({ name, username: username.toLowerCase(), email, password });
      setStep(2);
    } catch (err) {
  ...
  const handleVerifySubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await signupVerify(form.email, code);
          ...
          {step === 1 ? (
            <form onSubmit={handleInitSubmit} className="space-y-5">
              <div>
                ...
                <input
                  name="name" type="text" autoComplete="name" value={form.name} onChange={handleChange} placeholder="John Doe"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    name="password" type={showPassword ? 'text' : 'password'} autoComplete="new-password" value={form.password} onChange={handleChange} placeholder="Min. 6 characters"
              ...
              <div>
                ...
                <input
                  name="confirmPassword" type={showPassword ? 'text' : 'password'} autoComplete="new-password" value={form.confirmPassword} onChange={handleChange} placeholder="Re-enter your password"
